    ...
    public partial class Form1 : Form
    {
        ...
        private void Change_onClick(object sender, EventArgs e)
        {
            ...
            if (port != null && port.IsOpen)
            {
                ...
                MessageBox.Show("Change was successful", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
        ...
        private void Reset_onClick(object sender, EventArgs e)
        {
            if (port != null && port.IsOpen)
            {
                ...
                port.Write(String.Format("AT+UART={0}\r\n", Baud_Rate_box.SelectedItem.ToString() + ", 0, 0"));
